...
- 프로젝트 진행 ✔️  
  - 과거에 사람들이 상상한 미래
      ...
      - Team Misson2
        1. 실현된 기술\
           영상 1. 실시간 번역, 음성 인식을 통한 메세지 작성, 동작 인식, 실시간 번역, 화상통화, 이미지 검색\
           \
           영상 2. NFC, 노트패드, 터치 스크린, 영상통화 밑 화면 공유, 원격수업, 온라인 예매, 스마트 워치, 사물인터넷(IoT), 전기자동차, 인공지능 비서, OTT 서비스, 버츄얼 아이돌, VR기기, 자율주행자동차\
           \
           영상 3. 태블릿 등 개인 전자기기를 이용한 외부 디스플레이 제어, 자동차 내 터치 디스플레이 사용, 디자인 목적의 태양광 패널, 증강현실(AR)
        2. 느낀점\
