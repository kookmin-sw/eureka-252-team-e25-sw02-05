...
- 프로젝트 진행 ✔️  
  - 과거에 사람들이 상상한 미래
      ...
      - Team Misson2
        1. 실현된 기술\
           영상 1. 실시간 번역, 가상 시뮬레이션, 실시간 지도, 음성인식 및 실시간 텍스트 변환, 화상통화, 이미지 검색\
           \
           영상 2. 삼성페이(휴대폰 태그 방식 결제), 테블릿, 터치 스크린, 영상통화 밑 화면 공유, 원격수업, 온라인 예매, 애플워치, 사물인터넷, 전기자동차, 인공지능 비서(시리, 빅스비), 버츄얼 아이돌, VR기기, 자율주행자동차\
           \
           영상 3. 스케줄 관리 및 알람 기능 등이 탑재된 테블릿 상용화, 테블릿과 대형 디스플레이 연동, 자동차 내 터치 대쉬보드 사용, 태양광 패널 지붕, 테블릿 활용 수업, 3D카메라(포멧몬고), 디스플레이 간 화면 공유
        2. 느낀점\
