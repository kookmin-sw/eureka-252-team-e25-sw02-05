...
- 멘토링 ✔️  
  - 내 지도 교수 함께 만나기\
    Q. 학부 생활과 대학원 생활 사이에서 가장 크게 느끼신 차이점은 무엇인가요?\
    A. 생활하는 것 자체가 달라집니다. 학부 때는 내가 관심이 있는 과목을 듣고 다른 분야들도 들으면서 내가 갈 분야
를 정하는데, 대학원생은 이미 정해 놓은 분야에서 세부 분야를 정하는 것이기 때문에 그 부분이 크게 다릅니다. 또
한 개인적으로 공부하고 연구하는 것의 깊이가 달라지는 것 같습니다.\
    Q. 전공 이외에 교양 수업을 고를 때 듣는다면 개발자의 역량을 기르는데 도움이 되는 분야가 있을까요?\
    A. 개발자는 다른 사람들과 소통을 하는 것이 중요합니다. 자기 생각을 정리하고 그걸 전달하는 과정이 중요하다는
생각이 들어서 팀플이 많은 수업이 좋은 것 같습니다. 자기 코드를 자기만 보는 게 아니라 동료들에게 진행상황을
파악할 수 있게 설명해줘야 하기에 소통 역량이 굉장히 중요합니다.
